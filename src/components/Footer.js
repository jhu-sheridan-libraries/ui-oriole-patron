...
const Footer = () => {
    return (
      <Container className="jhu-footer col-8">
        <Nav>
          <Navbar>
            <NavItem><NavLink className="jhu-footer-link" href="https://catalyst.library.jhu.edu/info/libraries"><img id="footer-logo" alt="Johns Hopkins University Libraries" src="/logo.png" alt="" /></NavLink></NavItem>
